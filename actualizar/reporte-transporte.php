...
$link=Conectarse();
$sql="SELECT substring(codigo_reporte,7) AS correlativo FROM reporte_cab 
...
$FECHA=date('Y'); 
$CORRELATIVO=$ID+1;
$NUMERO="OV".$FECHA.ceros($CORRELATIVO, 6);
...
codigo_reporte,fecha,area,centro_costo,proveedor_cliente,
direccion,distrito,tipo_unidad,costo,guia,oc_os,ot,
comentario)
...
window.location='/control-de-transporte/reportes/reporte-transportistas';
...
header('Location: /control-de-transporte/consulta/cabecera');;
