	...
	<a href="/control-de-transporte/pages/detalle-reporte?codigo=<?php echo $row[codigo_reporte]; ?>"
	 target="_blank" class="btn btn-primary" title="CONSULTAR">
	<i class="glyphicon glyphicon-zoom-in"></i></a></td>
	<td>
	<a href="/control-de-transporte/reporte-excel/reporteexcel.php?codigo=<?php echo $row[codigo_reporte]; ?>&
	...
	<!-- 		
	<td>
	<a href="/control-de-transporte/reporte-excel/reporte-costo.php?codigo=<?php echo $row[codigo_reporte]; ?>&
	nombre=<?php echo $row[razonsocial]; ?>"
