...
<?php 
$link=Conectarse();
$sql="SELECT * FROM reporte_det WHERE codigo_reporte='$CODIGO' ORDER BY item";  
...
value="<?php echo $row[item]; ?>" min="1"required>
</div>
<div class="form-group">
